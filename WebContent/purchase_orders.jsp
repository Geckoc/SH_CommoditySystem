...
<br>
	<s:form action="addPurchaseOrder" name="addOrders" method="post" theme="simple">
		<table border="0">
			...
			<tr>
				<td>商品价格:</td>
				<td><input type="text" readonly="readonly" name="purchaseOrders_price" value='<s:property value="#session.search_list.commodity_price"/>'></td>
			</tr>
			<tr>
				<td>商品类型:</td>
			...
			<tr>
				<td>购买数量:</td>
				<td><input type="number" step="1" min="1" value="1" name="purchaseOrders_amount"></td>
			</tr>
			<tr>
			    <td valign="top" align="left">进货留言：</td>
				<td>
					<textarea rows="3" cols="20" name="purchaseOrders_message">
					</textarea>
				</td>
			</tr>
			<tr>
			...
			//	 String str1=d1.format(date);
				%>
				<td><input type="text" value=<%=simple.format(date) %> name="purchaseOrders_date" readonly="readonly"></td> 
			</tr>
			<tr>
